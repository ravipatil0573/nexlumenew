...
export const ContactSection = ({
  ...
  return (
    <section className="relative min-h-screen w-screen overflow-hidden bg-background">
      ...
      <div
        className="relative z-10 flex flex-col items-center justify-between w-full h-full p-4 md:p-8 lg:p-12">
        {/* Top Navigation (simplified for this component, can be a prop or slot) */}
        <nav
          className="w-full max-w-7xl flex items-center justify-between p-4 bg-card/70 backdrop-blur-sm rounded-lg shadow-lg mb-8">
        ...
        <div
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-7xl p-4 md:p-8 rounded-xl flex-grow">
          {/* Left Side: Title */}
          <div className="flex flex-col justify-end p-4 lg:p-8">
            <h1
              className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight drop-shadow-lg max-w-lg">
              {title}
            </h1>
          </div>
          ...
          <div
            className="bg-background/90 p-6 md:p-8 rounded-lg shadow-xl border border-border">
